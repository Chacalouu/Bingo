...
function twitchLogin() {
    const clientId = 'qkbjj0vcvegdx07w8a8s727ve5hpij';
    const redirectUri = 'https://chacalouu.github.io/Bingo/';
    ...
    if (accessToken) {
        fetch('https://api.twitch.tv/helix/users', {
            headers: {
                ...
                'Client-ID': 'qkbjj0vcvegdx07w8a8s727ve5hpij'
            }
        })
        ...
        .then(data => {
            ...
            if (user) {
                document.getElementById('pseudo-input').value = user.display_name;
